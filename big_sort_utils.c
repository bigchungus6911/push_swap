...
/* Return the index of val in arr, or -1 if not found. */
...
/* Rotate stack_b until its current maximum value is on top. */
...
/* Pull all elements from B to A, taking the maximum each time. */
